 ...
 * Posting Search Hook
 *
 * Custom hook for searching postings across dedicated endpoints
 * Mirrors useCareerPostSearch for consistent behavior
 */
...
export const usePostingSearch = (searchTerm: string) => {
