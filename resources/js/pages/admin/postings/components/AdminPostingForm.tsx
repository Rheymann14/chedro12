...
interface AdminPostingFormProps {
    ...
    setData: (key: keyof AdminPostingFormProps['data'], value: any) => void;
...
export const AdminPostingForm: React.FC<AdminPostingFormProps> = ({
    editing,
    data,
    setData,
    existingImages,
                    ...
                    <div className="flex w-70">
                        <div className="space-y-2">
                            <Label htmlFor="posted_date" className="flex items-center gap-2">                
                                ...
                                Post Date * 
                                {fieldErrors.posted_date && <span className="flex text-destructive text-sm">({fieldErrors.posted_date})</span>}
                            </Label>
