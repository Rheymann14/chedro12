...
import { regionalMemo, resources } from '@/routes';
...
// Using API-backed dynamic menu; no local defaults needed
...
export default function Resources() {
    ...
    useEffect(() => {
        fetch('/views/track', {
            ...
            .then(() => fetch('/views/count?page=resources'))
            .then((r) => r.json())
                ...
                <div className="mx-w-5 container p-4">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <div className="space-y-4 pt-2 md:col-span-2">
                            {/* Dynamic Menu (API-backed) */}
                            <DynamicMenuApi isAdmin={auth?.user?.role === 'admin'} />
